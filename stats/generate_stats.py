...
Excludes: node_modules, __pycache__, coverage, dist, build, target, _build, playwright-report, datasets, delme, .venv, array stores (*.zarr/)
</footer>
</div>
</body>
</html>
...
def generate_markdown_report(stats: dict[str, Any], output_file: Path) -> None:
    ...
    lines.append(
        ...
        "`delme`, `.venv`, array stores (`*.zarr/`). Source: `stats/generate_stats.py`._"
    )
    lines.append("")
