...
| `--saturation-exponent` | 0.44 | K ~ features^alpha. NOT content-only: it also shapes the mass-weighted split of an integer `--seeds` budget across UNIFORM tiles |
