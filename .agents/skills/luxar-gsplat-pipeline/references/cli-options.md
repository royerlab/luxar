...
| `--saturation-exponent` | 0.44 | K ~ features^alpha. NOT content-only: it also shapes the adaptive mass/foreground split of an integer `--seeds` budget across UNIFORM tiles |
