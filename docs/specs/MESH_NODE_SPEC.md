...
**Status:** Delivered — Phases 0–6 all landed (§11)
...
surface. These are routine outputs in the same scientific pipelines Luxar already serves, and they
could only be approximated by dense point clouds.
