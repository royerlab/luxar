...
**Status:** Delivered — Phases 0–6 landed (writer, cull kernels, drawable, shaded, picking + panel + stats, docs; §11); real WebGPU verified pixel-identical to WebGL (§11 row 6). LOD, spatial indexing, kind=partition and volumetric blending remain deliberate non-goals (§9).
