...
print(f"  Error:  {abs(glsl_approximation(2.0) - np.sqrt(2*np.pi)) / np.sqrt(2*np.pi) * 100:.2f}%")
...
try:
    popt, _ = curve_fit(fit_func, s_data, exact_data, p0=[2.0, 2.0, 0.5, 0.0], maxfev=10000)
