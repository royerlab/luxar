...
| `lodBias`          | `number`              | `1`             | Bias replacement LOD selection in screen-area units; `2` selects one occupancy-halved level finer, `4` selects two, and values below `1` select coarser levels sooner.                                       |
...
- `?lod-bias=<N>` — Bias replacement LOD selection in screen-area units (`2` = one level finer on occupancy-halved ladders; positive values only)
