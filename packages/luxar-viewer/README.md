...
- `?linePrimitive=<screen-space|volumetric>` — Select the line rendering primitive for the session (#1352): `volumetric` draws each segment as its true 3D density (exact end-on, seam-free joins); default `screen-space`
