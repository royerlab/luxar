...
| progressive (`residency-budget.ts`)    | Refusal-only settled-residency ceiling shared by the four refinement sweeps. Tracks sweep-registered progressive leaves across geometry types; lazy `lod_group` levels are outside this accounting. No README.                                                                                                                                                 |
