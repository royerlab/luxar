...
| File                    | Role                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bounds-math.ts`        | Side-effect-free geometry: `BoundingBox` / `BoundingSphere` types, `calculateBoundingBoxFromPositions`, `mergeBoundingBoxes`, `getBoundingBoxCenter` / `Size` / `MaxDimension` / `Diagonal`, `expandBoundingBox`, `isPointInBoundingBox`, `transformBoundingBox` (4x4 column-major), `boundingBoxToSphere`, `calculateClippingPlanesFromSphere`, `calculateCameraDistance` (FOV + aspect fit-ratio with 20% margin), `validateFOV`, and `projectBoundsToDisplayDims` (nD min/max → 3D box via `displayDims`). Exports the `MIN_NEAR_PLANE = 0.0001` and `SPHERE_SAFETY_EXPANSION = 1.05` constants used by the policy. |
