...
| File              | Role                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `templates/`      | HTML-string templates split by concern: shared primitives and formatting, Overview, Cache, Memory, Insights, and scene-graph rendering. `memory.ts` also re-exports `MemoryMetrics` and friends.                                                                                                                                                                                                                                                                                                                                                        |
