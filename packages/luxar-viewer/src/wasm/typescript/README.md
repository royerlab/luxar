...
- `decode.ts` frounds linear bounds and geolog-scalar anchors that arrive as f32 in WASM;
  its log-scalar kernels remain within one ULP of Rust's `expm1f` pending #1843.
