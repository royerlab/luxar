 ...
 * WebGL Mock
 *
 * Comprehensive mock of WebGL rendering context for tests.
 * Provides all required WebGL methods and properties without
 * requiring an actual WebGL context.
 */
 ...
 *
 * Provides all necessary WebGL methods for testing Three.js code
 * without requiring actual GPU/WebGL support.
 */
