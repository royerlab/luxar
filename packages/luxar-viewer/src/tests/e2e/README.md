...
| `captureElementScreenshot(page, selector, timeout?)`       | Capture one element's composited pixels as a PNG while hiding non-captured DOM.                                                                                                                                                                       |
| `samplePixelAt(page, selector, fx, fy)` / `samplePixelsAt` | Decode one element screenshot and read one or many canvas pixels while hiding non-captured DOM.                                                                                                                                                       |
