...
| `sound-attrs.ts`   | `parseSoundNodeAttrs(path, raw, sceneScale)` — defaults; `ref_distance` / `max_distance` left absent on disk default to `scale / 20` / `scale`; `attach_to` implies spatial; `ambisonic: "foa"` forces non-spatial; unknown enum values warn and fall back.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
