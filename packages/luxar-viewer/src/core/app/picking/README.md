...
| `sceneManager` (EventDispatcher) | `change`                    | `pickingSystem.markDirty()` after camera pose or projection changes; FOV and static near/far updates both change a fresh pick render and must dispatch this event         |
