...
export const SUPPORTED_SCENE_VERSIONS: readonly SceneFormatVersion[] = ['0.1', '0.2', '0.3'];
...
export const SUPPORTED_GSPLATS_FORMAT_VERSIONS: readonly GSplatsFormatVersion[] = [
  '3.0',
  '3.1',
  '3.2',
  '3.3',
