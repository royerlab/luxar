 ...
 *
 * @internal — no production call site outside this module.
 */
 ...
 *
 * @internal — no production call site outside this module. Note
 * `SceneDimsManager` has a same-named *method* that reads
