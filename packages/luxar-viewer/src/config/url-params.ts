...
export interface UrlParams {
   ...
   * fallback budgets, primary-tip pen routing, the Safari gesture-canceller
   * gate, and whether the help overlay lists its Touch section; long-press
   * menus and the rest of the tap-oriented copy land in follow-up touch work.
