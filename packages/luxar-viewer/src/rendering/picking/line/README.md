...
| File                     | Role                                                                                                                                                                                                              |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `material.ts`            | GLSL3 `THREE.ShaderMaterial` wrapper (`LinePickingMaterial`). Selects the screen-space or volumetric shader pair from the same `?linePrimitive=` resolution the visual material uses. Recompiles on `needsUpdate` |
