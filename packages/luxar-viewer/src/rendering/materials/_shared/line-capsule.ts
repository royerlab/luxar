 ...
 * which this model cannot provide: it binds only itself. #1488/#1490 have
 * no comparable cross-surface lock (#1488 has a single GLSL-only reach pin
 * in `line-capsule.test.ts` itself), so for them this sweep is it.
 * ============================================================
 */
