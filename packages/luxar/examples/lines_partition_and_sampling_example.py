...
Layout: three side-by-side line bundles to compare partitionting + sampling
...
def main() -> None:
    output_path = get_examples_output_dir() / "lines_partition_and_sampling_example.zarr"
    ...
    with LuxarZarrCompiler(str(output_path)) as compiler:
        ...
        verts_partition = make_line_bundle(
        ...
        scene.add_lines(
            ...
            line_type="segments",
            partition=dict(max_elements=1500),  # produces ~4 parts
            layer=True,
        )
