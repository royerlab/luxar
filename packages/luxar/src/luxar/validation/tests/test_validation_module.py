...
class TestPositionValidation:
    ...
    def test_non_numpy_positions(self):
    ...
    def test_high_dimensional_warning(self):
...
class TestColorValidation:
    ...
    def test_single_color_error(self):
    ...
    def test_hdr_color_warning(self):
...
class TestRadiiValidation:
    ...
    def test_mismatched_radii_count(self):
...
class TestSharpnessValidation:
    ...
    def test_2d_sharpness_error(self):
    ...
    def test_mismatched_sharpness_count(self):
    ...
    def test_negative_sharpness(self):
...
class TestContextParameter:
    ...
    def test_positions_with_context(self):
    ...
    def test_colors_with_context(self):
    ...
    def test_radii_with_context(self):
    ...
    def test_sharpness_with_context(self):
