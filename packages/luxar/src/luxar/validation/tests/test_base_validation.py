...
class TestValidatePositionsForWriting:
    ...
    def test_1d_array_with_helpful_error(self):
    ...
    def test_3d_array_with_helpful_error(self):
...
class TestValidateColorsForWriting:
    ...
    def test_wrong_shape_suggestions(self):
...
class TestValidateZarrAttributes:
    ...
    def test_valid_attributes_with_optional(self):
    ...
    def test_root_attributes_with_version(self):
    ...
    def test_root_missing_type(self):
