"""Regression tests for the Human Multiome demo's Points-LOD dependency gate.
...
``create_human_scene`` takes ``(output_path, coordinates, attributes,
...
def test_scene_builds_flat_without_lod_dep(
    ...
    out = tmp_path / "human.luxar.zarr"
    got = create_human_scene(out, coordinates, attributes, category_maps)
