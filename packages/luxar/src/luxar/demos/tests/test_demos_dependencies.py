...
class TestScannedModuleSet:
    ...
    Seven guards read :func:`scanned_demo_modules` — four here, plus the
    entry-point preflight, substitutive-LOD and Layers-panel guards next door.
    ...
    def test_the_set_is_a_denylist_over_every_module(self) -> None:
        ...
        # no edit here, or it would silently escape all seven guards.
