...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="luxar_demo_4d_fractals_") as tmpdir:
        ...
        aprint("")
        aprint("Try this:")
        aprint("  1. Start with Mandelbrot (fractal=0)")
        aprint("  2. Navigate W from -2 to +2")
        aprint("  3. Switch to Julia sets (fractal=1-5)")
        aprint("  4. Notice how different W slices show different complexity")
        aprint("")
        aprint("=" * 70)
