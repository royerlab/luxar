...
#: :func:`luxar.demos._support.datasets.cache.cache_computed`.
...
def cache_path(grid_size: int, seeds: int, iters: int) -> Path:
    ...
    one — the convention :func:`luxar.demos._support.datasets.cache.cache_computed` documents.
...
def load_or_build_orbitals() -> GSplatData:
    ...
    Follows the cache contract :func:`luxar.demos._support.datasets.cache.cache_computed`
