...
def _parse_content_length(headers: Any) -> int | None:
    ...
    :func:`luxar.demos._support.downloads.download.robust_download`, which is nested and so cannot
...
def _download_from_google_drive(
    ...
    :mod:`luxar.demos._support.downloads.download`, which is why ``robust_download`` cannot be used
    ...
    # arrived intact. `luxar.demos._support.downloads.download._force_identity_encoding` codifies
