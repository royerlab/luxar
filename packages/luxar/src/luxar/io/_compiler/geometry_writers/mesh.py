...
radius/width/covariance), and no LOD path — nor any partition path *of its own*:
``add_mesh(partition=...)`` splits the surface upstream and this writer just sees
one independent leaf per part. What remains is: encode
