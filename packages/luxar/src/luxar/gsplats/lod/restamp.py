...
def _refresh_level(
    ...
    *,
    ...
    rung_total_authored = "lod_n_lods" in authored.stats
    cutpoints_authored = "lod_cutpoints" in authored.stats
    ...
    if rung_total_authored:
        level_stats["lod_n_lods"] = len(level.additive_sublods)
    if cutpoints_authored:
        level_stats["lod_cutpoints"] = [
            int(value)
