...
class TestSolveLowerTriangular:
    ...
    def test_solve_2x2_single_rhs(self):
    ...
    def test_solve_3x3_multiple_rhs(self):
    ...
    def test_solve_batched_systems(self):
    ...
    def test_solve_single_dimension(self):
    ...
    def test_solve_different_dtypes(self):
    ...
    def test_solve_different_devices(self):
...
class TestNumericalStability:
    ...
    def test_well_conditioned_vs_manual_solution(self):
