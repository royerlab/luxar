...
class TestLossTypes:
    ...
    def test_mse_loss(self, simple_2d_image):
    ...
    def test_poisson_loss(self, simple_2d_image):
    ...
    def test_l1_loss_explicit(self, simple_2d_image):
    ...
    def test_different_losses_produce_different_results(self, simple_2d_image):
...
class TestAsymmetricPenalty:
    ...
    def test_asymmetric_penalty_with_mse(self, simple_2d_image):
    ...
    def test_asymmetric_penalty_with_poisson(self, simple_2d_image):
    ...
    def test_no_asymmetric_penalty(self, simple_2d_image):
...
class TestUniformImageHandling:
    ...
    def test_nearly_uniform_image(self):
...
class TestDeviceHandling:
    ...
    def test_mps_device_2d(self, simple_2d_image):
    ...
    def test_mps_device_3d(self, simple_3d_volume):
    ...
    def test_auto_device_detection(self, simple_2d_image):
...
class TestMovieRecording:
    ...
    def test_movie_recording_enabled(self, simple_2d_image):
    ...
    def test_movie_max_frames_limit(self, simple_2d_image):
    ...
    def test_movie_disabled_by_default(self, simple_2d_image):
...
class TestConvergenceEdgeCases:
    ...
    def test_best_state_restored(self, simple_2d_image):
    ...
    def test_convergence_early_termination(self, simple_2d_image):
...
class TestUpsampleForVisualization:
    ...
    def test_upsample_2d_nearest(self):
    ...
    def test_upsample_2d_linear(self):
    ...
    def test_upsample_2d_cubic(self):
    ...
    def test_upsample_3d_cubic(self):
    ...
    def test_upsample_no_op_same_shape(self):
...
class TestScaleFiltering:
    ...
    def test_scale_filtering_warning(self):
    ...
    def test_all_scales_too_large(self):
...
class TestInitializationEdgeCases:
    ...
    def test_zero_initialization_coverage(self, simple_2d_image):
...
class TestDecompositionLossEdgeCases:
    ...
    def test_loss_with_mse_no_asymmetric(self, simple_2d_image):
    ...
    def test_loss_with_poisson_no_asymmetric(self, simple_2d_image):
...
class TestVerboseOutput:
    ...
    def test_verbose_mode(self, simple_2d_image):
    ...
    def test_verbose_no_convergence(self, simple_2d_image):
...
class TestBestStateTracking:
    ...
    def test_best_state_tracking_with_oscillation(self, simple_2d_image):
...
class Test3DInterpolationFallbacks:
    ...
    def test_3d_cubic_uses_keys_cubic(self, simple_3d_volume):
    ...
    def test_3d_nearest_mode(self, simple_3d_volume):
...
class TestNormPercentile:
    ...
    def test_norm_percentile_zero(self, simple_2d_image):
    ...
    def test_norm_percentile_robust(self):
...
class TestCubicInterpolationEdgeCases:
    ...
    def test_cubic_upsample_fractional_scaling(self):
...
class TestInitializationMethodSelection:
    ...
    def test_init_method_pyramid_explicit(self, simple_2d_image):
    ...
    def test_init_method_finest_explicit(self, simple_2d_image):
    ...
    def test_init_method_uniform_explicit(self, simple_2d_image):
    ...
    def test_init_method_zero_explicit(self, simple_2d_image):
...
class TestMovieFrameFIFO:
    ...
    def test_movie_fifo_buffer_overflow(self, simple_2d_image):
...
class TestBestStateFallback:
    ...
    def test_best_state_fallback_when_no_best_saved(self, simple_2d_image):
...
class TestLossComputationHelpers:
    ...
    def test_decomposition_loss_l1_symmetric(self, simple_2d_image):
    ...
    def test_decomposition_loss_mse_symmetric(self, simple_2d_image):
    ...
    def test_decomposition_loss_poisson_symmetric(self, simple_2d_image):
