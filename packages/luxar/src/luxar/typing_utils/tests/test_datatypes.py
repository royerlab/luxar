...
class TestDataTypeConfigInit:
    ...
    def test_custom_mode_requires_all_dtypes(self):
    ...
    def test_custom_mode_with_all_dtypes(self):
...
class TestDataTypeConfigColorDtype:
    ...
    def test_auto_mode_hdr_colors(self):
    ...
    def test_auto_mode_standard_colors(self):
    ...
    def test_auto_mode_no_data(self):
        """Test AUTO mode without data."""
        config = DataTypeConfig(mode=DataTypeMode.AUTO)
        # Default to uint8 for memory efficiency
        assert config.get_color_dtype() == np.uint8

    def test_auto_mode_negative_colors(self):
...
class TestDataTypeConfigRadiusDtype:
    ...
    def test_auto_mode_small_range(self):
    ...
    def test_auto_mode_medium_range(self):
    ...
    def test_auto_mode_large_range(self):
...
class TestDataTypeConfigSharpnessDtype:
    ...
    def test_auto_mode_typical_range(self):
...
class TestConvertArrayDtype:
    ...
    def test_float_to_uint8_with_normalize(self):
    ...
    def test_float_to_uint8_with_custom_range(self):
    ...
    def test_float_to_uint8_degenerate_range(self):
    ...
    def test_float_to_uint8_without_normalize(self):
    ...
    def test_float_to_uint16_with_normalize(self):
    ...
    def test_float_to_uint16_without_normalize(self):
    ...
    def test_uint8_to_float_with_normalize(self):
    ...
    def test_uint8_to_float_with_custom_range(self):
    ...
    def test_uint8_to_float_without_normalize(self):
    ...
    def test_uint16_to_float_with_normalize(self):
    ...
    def test_uint16_to_float_without_normalize(self):
...
class TestInferOptimalDtype:
    ...
    def test_position_inference(self):
    ...
    def test_color_hdr_inference(self):
    ...
    def test_color_standard_inference(self):
    ...
    def test_color_unusual_range(self):
    ...
    def test_radius_small_range(self):
    ...
    def test_radius_medium_range(self):
    ...
    def test_radius_large_range(self):
    ...
    def test_sharpness_inference(self):
...
class TestValidateDtypeString:
    ...
    def test_invalid_position_dtypes(self):
    ...
    def test_invalid_color_dtypes(self):
    ...
    def test_valid_radius_dtypes(self):
    ...
    def test_invalid_radius_dtypes(self):
    ...
    def test_valid_sharpness_dtypes(self):
