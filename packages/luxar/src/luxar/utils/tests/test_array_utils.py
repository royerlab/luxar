...
class TestBroadcastColorToPoints:
    ...
    def test_single_rgb_list(self) -> None:
    ...
    def test_single_rgb_array(self) -> None:
    ...
    def test_full_color_array(self) -> None:
...
class TestBroadcastScalarToPoints:
    ...
    def test_negative_scalar_with_positive_required(self) -> None:
    ...
    def test_wrong_array_shape(self) -> None:
...
class TestBroadcastRadiiToPoints:
    ...
    def test_full_radii_array(self) -> None:
...
class TestBroadcastSharpnessToPoints:
    ...
    def test_none_sharpness(self) -> None:
    ...
    def test_full_sharpness_array(self) -> None:
    ...
    def test_out_of_range_array_warning(self) -> None:
    ...
    def test_no_warning_suppression(self) -> None:
...
class TestEnsureFloat32:
    ...
    def test_uint8_conversion(self) -> None:
...
class TestValidateArrayShape:
    ...
    def test_exact_shape_mismatch(self) -> None:
        """Test exact shape mismatch raises."""
        array = np.zeros((10, 3))
        with pytest.raises(ValueError, match="must have shape"):
            validate_array_shape(array, (10, 4))

    def test_multiple_valid_shapes(self) -> None:
    ...
    def test_multiple_shapes_all_invalid(self) -> None:
