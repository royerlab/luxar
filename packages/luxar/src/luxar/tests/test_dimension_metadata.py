...
from luxar.types import DimensionMetadata, validate_dimension_metadata, validate_positions
...
class TestDimensionValidation:
    ...
    def test_validate_dimension_metadata(self):
        ...
        # Wrong count
        with pytest.raises(ValueError, match="Expected 3 dimension metadata entries, got 2"):
...
class TestSceneDimensionMetadata:
    ...
    def test_mixed_dimensionality(self, tmp_path):
        ...
        points_2d = scene.add_points("points_2d", pos_2d, dimension_metadata=metadata_2d)
