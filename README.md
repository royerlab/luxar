...
**[▶ Try it in your browser](https://demos.luxarviewer.dev)** — 85 live demos, no
...
> [demos.luxarviewer.dev](https://demos.luxarviewer.dev)** hosts all 85 demos as
> live scenes you can orbit, slice and navigate in the browser — the same
> compiled archives this README describes, streamed from object storage.
...
| [![Human White-Matter Tractography — 87 dMRI tracts](docs/images/readme/gallery/dmri_tractography.webp)](docs/images/readme/gallery/dmri_tractography.webm) | [![Cells3D Isosurfaces — shaded triangle meshes](docs/images/readme/gallery/mesh_isosurface_cells3d.webp)](docs/images/readme/gallery/mesh_isosurface_cells3d.webm) | |
| **White-Matter Tractography**<br>87 human dMRI tracts | **Cells3D Isosurfaces**<br>shaded membrane + nuclei surfaces | |
...
|----------|-------------|
| **[Live demo gallery](https://demos.luxarviewer.dev)** | All 85 demos as interactive scenes in the browser |
