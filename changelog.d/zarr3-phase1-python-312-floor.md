...
deterministically within 24 h rather than on every PR. The full-matrix set is
exactly what the published classifiers advertise (3.12–3.14), so "declared" and
