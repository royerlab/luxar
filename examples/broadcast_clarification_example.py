...
dimensions = luxar.Dimensions([
    ...
    luxar.Dimension(name="Time", unit="frame", range=(0, 2), display=False, step=1.0, discrete=True),
])
...
aprint("2. Broadcasting means 'show these points at all values of specified dimensions'")
