...
ANALYSIS_DIR = Path(__file__).resolve().parent.parent / "analysis" / "splat_count_vs_quality"
...
def main():
    ...
    parser.add_argument(
        "--output",
        default=None,
        help="Output PDF path (default: figs/fig_visual_comparison.pdf)",
    )
    ...
    output_path = Path(args.output) if args.output else (
        Path(__file__).resolve().parent / "figs" / "fig_visual_comparison.pdf"
    )
