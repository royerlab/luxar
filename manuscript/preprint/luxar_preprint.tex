...
When compared against H.265 video compression using a Noise2Self held-out framework that measures true signal recovery, Gaussian splats achieve up to 3~dB higher held-out PSNR on noisy confocal data (Supplementary Fig.~3).
